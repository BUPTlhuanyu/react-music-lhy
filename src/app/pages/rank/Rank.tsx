...
import {IStoreState, ITopList, ISongListItem} from 'store/stateTypes';
...
interface RankPropType {
    ...
    location: any;
    match: any;
    setTopList: (topList: ITopList) => void;
}
        ...
        return (
            <div className="rank">
                <Scroll className="toplist">
                    <ul>
                        {!!topListArr.length
                            && topListArr.map((item: ITopList, index: number) => (
                                <li
                                    className="item"
                                    key={index}
                                    onClick={() => {
                                ...
                                >
                                    ...
                                    <ul className="songlist">
                                        {item.songList
                                            && item.songList.map((song: ISongListItem, index: number) => (
