...
import {setPlaying, setFullScreen, setSequenceList, setPlaylist, setCurrentIndex, setPlayMode} from 'actions/player';
    ...
    render() {
        ...
        return (
            <div className="music-list">
                ...
                <div className="bg-layer" ref={this.layer} />
...
const mapDispatchToProps = (dispatch: Dispatch) => {
    return {
        setPlaying: (playing: IPlaying) => dispatch(setPlaying(playing)),
        setFullScreen: (fullScreen: IFullScreen) => dispatch(setFullScreen(fullScreen)),
        setSequenceList: (list: ISequenceList) => dispatch(setSequenceList(list)),
        setPlaylist: (list: IPlaylist) => dispatch(setPlaylist(list)),
        setCurrentIndex: (index: ICurrentIndex) => dispatch(setCurrentIndex(index)),
